...
public class TelaRelogio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(52, 43, 224));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/calendario1.png"))); // NOI18N

        jLabel2.setFont(new java.awt.Font("Ubuntu", 1, 18)); // NOI18N
        jLabel2.setText("Data e Hora Atuais");

        lblHora.setBackground(new java.awt.Color(0, 255, 108));
        lblHora.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        lblHora.setForeground(new java.awt.Color(251, 24, 207));
        lblHora.setText("Clique no botão");

        btnHora.setText("Pressione aqui");
